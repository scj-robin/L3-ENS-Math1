...
\begin{enumerate}
  ...
  \solution{Tous les états sont accessibles à partir de tous les états donc l'unique classe de communication est $\Ecal$ tout entier. Une telle chaîne est dite irréductible.}
  %
