...
%   & \frac1{\sqrt{n}} \|x\|_2 \leq \|x\|_1 \leq n \|x\|_2.
  ...
  \begin{enumerate}
    ...
    $$
    \item en remarquant que, par Cauchy-Schwartz, on a
%     la boule unité de la norme $\|\cdot\|_2$ est incluse dans la boule de rayon $\sqrt{n}$ de la norme $\|\cdot\|_1$, il vient que 
%     $$
...
%     $$
    ...
    $$
    où chaque $|x_i|^2$ apparaît $n-1$ fois dans le 2nd terme, soit
    $$
    \|x\|_1^2 \leq \sum_i n |x_i|^2 = n \|x\|_2^2
    $$
    soit $\|x\|_1 \leq \sqrt{n} \|x\|_2$.
  \end{enumerate}
\end{description}
