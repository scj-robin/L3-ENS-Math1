...
\begin{tabular}{ll}
  ...
  $(\lambda_1, \lambda_2) \in \Cbb, \Re(\lambda_1, \lambda_2) > 0 :$ & point de répulsion ou 'source en spirale'. \\
...
$$
Il reste alors à trouver des primitives de $h_1'$ et $h_2'$ pour déterminer un hamiltonien de la forme $H(x, y) = h_1(x) + h_2(y)$.
