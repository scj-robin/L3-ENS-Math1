...
\begin{enumerate}
  ...
  \solution{
    ...
    $$
    \includegraphics[width=.5\textwidth, trim=30 30 20 50, clip=]{Lorenz2D-a17-b267-gradientField}
    $$
  }
  %
  ...
  \solution{
    Une partie imaginaire non nulle des valeurs propres induit un phénomène de rotation autour du point stationnaire.
    $$
    \begin{array}{cc}
      a < b/8 & a > b/8 \\
      \includegraphics[width=.4\textwidth, trim=30 30 20 50, clip=]{Lorenz2D-a17-b267-paths} &
      \includegraphics[width=.4\textwidth, trim=30 30 20 50, clip=]{Lorenz2D-a1667-b267-paths}
    \end{array}
    $$
  }
\end{enumerate}
