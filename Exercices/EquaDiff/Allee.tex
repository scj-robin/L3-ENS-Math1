...
\begin{enumerate}
  ...
  \solution{
    Comme suggéré par l'énoncé, on calcule $\dot v(t) = -6 e^{-2t}$ et on remarque que $\dot v = 2 (1 - v)$. On remarque ensuite que $u(t) = 1 + 1/\sqrt{v(t)}$ et qu'on a donc, d'une part, 
    $$
    \dot u 
    = -\frac{\dot v}{2 v^{3/2}}
    = \frac{v - 1}{v^{3/2}}
