% %-------------------------------------------------------------------------------
\subsubsection{Chémostat (simplifié) \todo{Vérifier}}
%-------------------------------------------------------------------------------
...
\begin{enumerate}
  ...
  %
  \item \todo{Finir} \'Etudier la stabilité de chacun des points d'équilibre en supposant que les conditions établies à la question \ref{q:chemostatDistincts} sont vérifiées.
  \solution{
  \begin{description}
