...
\newpage \section{Algèbre linéaire} \input{Exos-AlgLin}

\newpage \section{Fonctions de plusieurs variables} \input{Exos-MultiVar}

\newpage \section{\'Equations différentielles et systèmes dynamiques} \input{Exos-EquaDiff}

\newpage \section{Probabilités} \input{Exos-Probas}
