...
\begin{enumerate}
  \item Déterminer ses points stationnaires.
  \solution{Ses points stationnaires sont les racines du polynôme $P(y) = - y^3 + 7 y^2 - 14 y + 8$, donc $y_1 = 1$ fait partie, donc
  $$
  P(y) = (y-1) (-y^2 + 6y - 8),
  $$
  ...
  $$}
  \item Déterminer la nature de chacun d'eux.
  \solution{Leur stabilité est donnée par la dérivée de $P$:
  $$
  P'(y) = -3y^2 + 14 y - 14,
  $$
  soit
  ...
  \item Tracer le graphe de stabilité.
  \solution{
  $$
