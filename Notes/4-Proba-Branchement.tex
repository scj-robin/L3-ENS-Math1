...
\proof
On a écarté le cas $f_x(0) = \Pr\{X = 0\} = 0$, qui implique que chaque individu a au moins un descendant et donc que $q = 0$. \\
...
$$
$q$ est donc bien un point fixe de $f$. Le lemme \ref{lem:BGWnombrePointsFixes} indique que leur nombre dépend de la posuition de $m$ par rapport à 1.Il nous reste montrer la convergence vers le plus petit d'entre eux.
