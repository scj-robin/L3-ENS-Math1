...
\usepackage[a4paper,top=2cm,bottom=3cm,left=1.5cm,right=1.5cm,marginparwidth=0.5cm]{geometry}
...
\date{Examen, le 11 février 2026}
...
\bigskip
A faire : traiter complètement un exercice, au choix, et en commencer un deuxième, également au choix.
