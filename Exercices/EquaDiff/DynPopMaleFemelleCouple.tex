...
\begin{enumerate}
  ...
  déduire que les fonctions $y$ et $z$ satisfont le système 
  ...
  \begin{itemize}
    ...
    $$
    dont les seuls pertinents pour le modèle sont ceux qui se situent dans le cadrant positif, c'est-à-dire
    $$
    (y=0, z=0), \qquad
  ...
  \item \'Ecrire la matrice jacobienne du système \eqref{eq:Dyn3Pop2} et étudier la nature du ou des équilibres pertinents du point de vue de la dynamique de la population.
