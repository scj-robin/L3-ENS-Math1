...
%-------------------------------------------------------------------------------
\todo{Modèle dynamique d'évolution de fréquences alléliques \\ (AlgLin/EvolutionFrequenceAlleliques)}
...
%-------------------------------------------------------------------------------
\todo{Exercice 7 de Lambert (application linéaire tangente)}
...
%-------------------------------------------------------------------------------
\todo{Galton-Watson Poisson + multipop (sauf si fait en TD)}
