...
\begin{enumerate}
  ...
  %
  \item Montrer que les valeurs propres de $J^*$ sont réelles si et seulement si $a \geq 2 f(m)$. Dans la suite, on notera $a_1 = 2 f(m)$. 
...
\begin{enumerate}
  ...
  Après extinction des prédateurs, la population des proies tend donc vers $x_2 = 1/a = 2/3$ : elle n'explose donc pas, contrairement au modèle de Lotka-Volterra classique, du fait de la densité-dépendance.
  }
\end{enumerate}
