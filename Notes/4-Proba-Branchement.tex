...
\begin{itemize}
  ...
  $$
  La fonction $f_X$ est donc monotone croissante sur $[0, 1]$ et strictement convexe sur $(0, 1]$ avec $f_X(0) > 0$ et $f'_X(1) > 1$. Son graphe coupe donc la première bissectrice 
  \begin{itemize}
  \item en $s^* < 1$ et en 1 si $m > 1$,
  \item en 1 seulement si $m \leq 1$.
  \end{itemize}
\end{itemize}
\eproof
