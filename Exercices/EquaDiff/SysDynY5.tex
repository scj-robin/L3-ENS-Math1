%-------------------------------------------------------------------------------
\subsubsection{Système dynamique en $y^5$ \todo{Bof : hyper calculatoire}}
%-------------------------------------------------------------------------------
...
\begin{enumerate}
  ...
  $$
  quand ils existent, le système admet donc 
  \begin{itemize}
    \item un unique point d'équilibre en $y_0^*$ si $\mu \leq -1$; 
    \item trois points d'équilibre en $y_0^*$, $y_1^* = y_2^* = 1$ et $-y_1^* = - y_2^* = -1$  si $\mu = -1$; 
    \item cinq points d'équilibre en $y_0^*$, $y_1^*$, $y_2^*$, $-y_1^*$ et $-y_2^*$ si $-1 < \mu < 0$;
    \item trois points d'équilibre en $y_0^*$, $y_2^*$ et $-y_2^*$ si $\mu \geq 0$.
  \end{itemize}
}
  %
