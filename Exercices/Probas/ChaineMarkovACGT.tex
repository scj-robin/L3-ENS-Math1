...
On considère une chaîne de Markov $X=(X_n, n\in \Nbb)$ à valeurs dans $\Ecal = \{A, T, G, C\}$. Pour $i,j\in \Ecal$, on note $p_{ij}$ la probabilité de transition de $i$ vers $j$ et on suppose que $p_{ij}\not=0$ dès que $i\not=j$.
