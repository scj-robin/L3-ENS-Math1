...
On considère une chaîne de Markov $(X_n)_{n \geq 0}$ prenant ses valeurs dans $\{1, 2, 3, 4\}$, et on note $p_{i, j}$ la probabilité de transition de $i$ à $j$. On suppose que $p_{1, 1} = p_{4, 4} = 1$, que $p_{2, 3} = 1 - p_{2, 1} =: p$ et que $p_{3, 2} = 1 - p_{3, 4} =: q$.
\begin{enumerate}
