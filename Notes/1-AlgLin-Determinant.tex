...
\eproof
% \parSR{Démonstration du théorème \ref{thm:uniciteDeterminant}.}
...
\parSR{Démonstration du Lemme \ref{lem:determinantNul}.}
\begin{enumerate}[($i$)]
...
\parSR{Démonstration de la proposition \ref{prop:determinantMatriceTriangulaire}.}
...
\parSR{Démonstration de la proposition \ref{prop:inverseMatriceCofacteurs}.} 
...
\begin{description}
  ...
  Cette matrice possède donc deux lignes égales (la $i$-ème et la $k$-ème), son déterminant est donc nul, donc $c_{ik} = 0$.
\end{description}
