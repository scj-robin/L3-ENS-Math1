...
\begin{enumerate}
  \item Donner la valeur $(x^*, y^*)$ de l’unique équilibre ``non trivial''
%   \footnote{'Trivial' signifie à la fois évident et sans intérêt. En l'occurrence, le point d'équilibre trivial est le point $(0, 0)$.} 
  de ce système dans le quadrant positif. Quel est l’autre équilibre ?
