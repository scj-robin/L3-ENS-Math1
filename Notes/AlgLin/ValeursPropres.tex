...
\begin{proposition} \label{prop:A-lambdaI_NonInversible}
  $\lambda$ est une valeur propre de la matrice $A$ si et seulement si la matrice $A - \lambda I$ n'est pas inversible.
\end{proposition}

\proof
\begin{description}
 \item[$\Rightarrow$:] Si $\lambda$ est valeur propre de $A$, l'équation
...
\proof 
C'est une conséquence directe de la proposition \ref{prop:A-lambdaI_NonInversible} et de la définition du polynôme caractéristique
\eproof
...
%   \begin{itemize}
%     \item Polynôme caractéristique $P_A(\lambda) = |A - \lambda I|$
%   \end{itemize}    
% \end{enumerate}
% Programme cours 2
% \begin{enumerate}
...
\begin{corollary*}[Polynôme caractéristique] %\label{cor:factorisationPolynomeCaracteristique}
