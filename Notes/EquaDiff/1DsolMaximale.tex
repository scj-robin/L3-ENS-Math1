...
\begin{description}
  ...
  \item[Solution $y_0 < 0$ ou $y_0 > K$ :] 
  %\textcolor{gray}{on peut étudier ces cas de façon analogue au cas $y_0 \in ]0; K[$ en remarquant que pour une fonction $f$ dérivable possiblement négative ${\dot f}/{f} = \partial t \log |f|$.} \\
  ...
  On remarque aussi qu'on a alors
  $$
